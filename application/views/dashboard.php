            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="#"><i class="fa fa-user fa-fw"></i><?php echo $this->session->userdata['logged_in']['role']; ?></a>
                        </li>
                        ...
                        <li class="divider"></li>
                        <li><a href="/ci/logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url();?>server/serverstatus/services">Services</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>server/serverstatus/ports">Ports</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>server/serverstatus/usage">Usage</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>server/serverstatus/stats">Statistics</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                       ...
                       <?php  if($this->session->userdata['logged_in']['role'] == 'admin') { ?>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-info fa-fw"></i>Important<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url();?>server/imp/commands">Commands</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>server/imp/links">Links</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>server/imp/tutos">Tutorials</a>
                                </li>
